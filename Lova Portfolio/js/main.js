...
(() =>{
    ...
    humbergerBtn.addEventListener("click", showNavMenu);
    ...
    document.addEventListener("click", (event) =>{
        if(event.target.classList.contains('link-item')){
            ...
            if(event.target.hash !==""){
                ...
                /* if clicked 'link-itemis contained within the navigation menu' */
...
(() =>{
    ...
    filterContainer.addEventListener("click", (event)=>{
        ...
        !event.target.classList.contains("active")){
            ...
            // activate new filter 'filter item'
            event.target.classList.add("active","outer-shadow");
            const target = event.target.getAttribute("data-target");
    ...
    portfolioItemsContainer.addEventListener("click", (event) =>{
        if(event.target.closest(".portfolio-item-inner")){
            ...
            itemIndex = Array.from(portfolioItem.parentElement.children).indexOf(
                portfolioItem);
            screenshots = portfolioItems[itemIndex].querySelector(".portfolio-item-img img").getAttribute("data-screenshoots");
            //convert screenshoot
    ...
    function popupDetails(){
        ...
        if(!portfolioItems[itemIndex].querySelector(".portfolio-item-details")){
            ...
            return; // end fonction execution
        }
        projectDetailsBtn.style.display = "block";
        // get the project details
        const details = portfolioItems[itemIndex].querySelector(".portfolio-item-details").innerHTML;
        //set the project details
        popup.querySelector(".pp-project-details").innerHTML;
